...
export class SoftwareService {
  ...
  addSoftware(newSoftware: SoftwareInputDTO): Observable<SoftwareInputDTO> {
    ...
    return this.http.post<SoftwareInputDTO>(this.baseUrl, newSoftware, this.httpOptions)
      .pipe(
        tap((addedSoftware: SoftwareInputDTO) => console.log('Software aggiunto:', addedSoftware)),
        catchError(this.handleError)
      );    
  }

  //PUT
  updateSoftware(id: number, updatedSoftware: SoftwareInputDTO): Observable<SoftwareInputDTO> {
    const url = `${this.baseUrl}/${id}`;
    return this.http.put<SoftwareInputDTO>(url, updatedSoftware, this.httpOptions)
      .pipe(
        tap((software: SoftwareInputDTO) => console.log('Software aggiornato:', software)),
        catchError(this.handleError)
      );
  }
